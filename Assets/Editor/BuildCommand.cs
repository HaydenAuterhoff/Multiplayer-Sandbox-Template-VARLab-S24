...
static class BuildCommand
{
    ...
    static void PerformBuild()
    {
        ...
        string buildTargetName = GetArgument("customBuildTarget");
        bool isBuildTargetScorm = (buildTargetName.ToLower() == "scorm") ? true : false;

        var buildTarget = isBuildTargetScorm ? BuildTarget.WebGL : GetBuildTarget();
        ...
        if(isBuildTargetScorm) BuildSCORM();
    }

    private static void BuildSCORM()
    {
        Console.WriteLine(":: Performing SCORM build");
        SCORMBuilder.Publish();
        Console.WriteLine(":: Done with SCORM build");
    }
